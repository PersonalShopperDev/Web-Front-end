...
import styles from '../src/styles/listup.module.scss'
import Stylist from '../src/components/stylist';
    ...
    <Layout>
      <div className={styles.background}>
        <div className={styles.container}>
          ...
          <main className={styles.main}>{!isRanking ? person.map(item => <Stylist info={item}/> ) : null}</main>
          <Footer />
        </div>
      </div>
    </Layout>
